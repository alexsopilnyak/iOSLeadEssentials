...
//  EssentialFeed
//
//  Created by Oleksandr Sopilniak on 22.05.2023.
//
...
public class CodableFeedStore: FeedStore {
    ...
    private let queue = DispatchQueue(label: "\(CodableFeedStore.self)_queue", qos: .userInitiated, attributes: .concurrent)
